...
if args.genotype:
    ...
    parser.add_argument('--scoref' , type=int,default=30,help="Minimum fisher log p score of variants default = 30")
    parser.add_argument('--scoren' , type=int,default=20,help="Minimum non-parametric phred score of variants default = 20")
