...
the function checks if there is an hit and returns it
    ...
    if chrA in allVariations:
        ...
        if chrB in allVariations[chrA]:
            ...
            for i in range(0,len(allVariations[chrA][chrB])):
                event=allVariations[chrA][chrB][i]
